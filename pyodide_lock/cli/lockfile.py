...
@main.command()
def add_wheels(
    wheels: Annotated[List[Path],typer.Argument(help="list of wheels to add to the lockfile",default="[]")],
    in_lockfile: Path = "pyodide-lock.json",
    out_lockfile: Path = "pyodide-lock-new.json",
):
